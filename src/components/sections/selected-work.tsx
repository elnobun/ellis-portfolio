      ...
      <Container className="space-y-12">
        <Reveal className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-xl">
            ...
            <p className="mt-3 text-[1.02rem] leading-8 text-muted-foreground">A selection of recent engineering challenges solved through thoughtful architecture and elegant interfaces.</p>
          </div>

  ...
  if (sanityEnabled && sanityClient) {
    ...
    if (data) {
      ...
      return {
        ...
        languages: mappedContent.languages.length ? mappedContent.languages : aboutContent.languages,
        frameworksTitle: mappedContent.frameworksTitle || aboutContent.frameworksTitle,
        frameworks: mappedContent.frameworks.length ? mappedContent.frameworks : aboutContent.frameworks,
        ...
        infrastructureItems: mappedContent.infrastructureItems.length ? mappedContent.infrastructureItems : aboutContent.infrastructureItems,
